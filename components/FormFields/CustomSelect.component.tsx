...
const CustomSelect = (props: SelectProps) => {
    const { borderRadius,disabled, options, value, onChange, placeholder = 'Select...', title, isSearchable = true, className, error, isMulti, required, loadMore, menuOpen } = props;
    const customStyles = {
