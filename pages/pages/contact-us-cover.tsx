                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form className="space-y-5" onSubmit={submitForm}>
                                ...
                                <button type="submit" className="btn btn-dred !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                    Submit
                                </button>
                            </form>
                        </div>
                        <p className="absolute bottom-6 w-full text-center dark:text-white">© {new Date().getFullYear()}.Repute All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
