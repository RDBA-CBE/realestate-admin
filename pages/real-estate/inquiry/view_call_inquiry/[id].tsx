...
const View_CallInquiry = () => {
  ...
  const getDetails = async () => {
    try {
      ...
      const res: any = await Models.inquiry.callback_view(id);
  ...
  console.log("first",state.property_name?.value,state.detail?.property_details?.id)
    ...
    try {
      ...
      const body = {
        ...
        interested_property: state.property_name?.value
          ...
          : state.detail?.property_details?.id?[state.detail?.property_details?.id]:null,
  ...
  const delete_call_inquiry = async () => {
    try {
      const res: any = await Models.inquiry.callback_delete(id);
    } catch (error) {
      console.log("✌️error --->", error);
    }
  };
    ...
    <div className="mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h5 className="text-xl font-bold text-gray-800">Callback Inquiry</h5>
      ...
      {state.moveToLead && (
        ...
        <div className={`mt-3 w-full`}>
          ...
          <div className="flex flex-col gap-3 pt-2 md:flex-row md:justify-end">
            ...
            <button
              type="button"
              className="btn btn-dred w-full md:w-auto border-none"
