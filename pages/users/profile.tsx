...
import { UserCheck, Building2, Camera, Calendar, Check } from "lucide-react";
...
export default function Profile() {
  ...
  //     const formData = dynamicInputbuildFormData(body);
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: <IconLockDots className="h-4 w-4" />,
    },
  ];
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-3.5 lg:grid-cols-4">
        ...
        <div className="lg:col-span-1">
          {/* Avatar Card */}
          <div className="panel overflow-hidden rounded-xl border p-0 shadow-none">
            ...
            <div className="flex flex-col items-center px-5 pb-5">
              ...
              {state.profile?.email && (
                <p className="mt-2 max-w-full truncate px-2 text-xs text-gray-400">
                  {state.profile?.email}
                </p>
              )}
            </div>
          ...
          {/* Nav */}
          <div className="panel mt-4 rounded-xl border px-2 py-5 shadow-none">
        ...
        {/* ── Main Content ── */}
        <div className="panel rounded-xl border shadow-none lg:col-span-3">
          {/* PROFILE TAB */}
          {activeTab === "profile" && (
            <div>
                ...
                <button
                  onClick={() =>
                    setState({
                      ...
                      years_in_business: state?.profile?.years_in_business,
                      location: state?.profile?.location?.map((item: any) => ({
                        label: item?.name,
                        value: item?.id,
                      })),
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                {state.profile?.years_in_business && (
                  <InfoCard
                    icon={<IconMapPin className="h-4 w-4" />}
                    label="Years in Business"
                    value={`${state.profile?.years_in_business}`}
                  />
                )}
              ...
              <div className="mt-4">
                {state.profile?.specialization?.length > 0 && (
                  <div className="rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                      {state.profile?.specialization?.map(
                        (item: any, index: number) => (
                          <div key={index} className="flex items-start gap-3">
                            <div className="bg-dred mt-0.5 shrink-0  rounded-full p-0.5 text-[#fff]">
        ...
        renderComponent={() => (
          <div className="space-y-4 p-2">
            ...
            <TextInput
              ...
              placeholder="Enter your number of years in industry"
              value={state.years_in_business}
              onChange={(e) => setState({ years_in_business: e.target.value })}
              icon={<Calendar />}
            />
            ...
            <CustomSelect
              ...
              onChange={(selectedOption) =>
                setState({ location: selectedOption })
              }
              isClearable
